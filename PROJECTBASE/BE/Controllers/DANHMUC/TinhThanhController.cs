...
using REPONSITORY.DANHMUC.TINHTHANH;

namespace BE.Controllers.DANHMUC
{
    [Route("api/[controller]")]
    [ApiController]
    public class TinhThanhController : BaseController<TinhThanhController>
    {
        ITINHTHANHService _service;
        ...
        public IActionResult Insert(PostTinhThanhRequest request)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        public IActionResult Update(PostTinhThanhRequest request)
        {
            try
            {
                if (!ModelState.IsValid)
