...
using REPONSITORY.DANHMUC.PHUONGXA;

namespace BE.Controllers.DANHMUC
{
    [Route("api/[controller]")]
    [ApiController]
    public class PhuongXaController : BaseController<PhuongXaController>
    {
        IPHUONGXAService _service;
        public PhuongXaController(IPHUONGXAService service)
        {
            _service = service;
        }
        ...
        public IActionResult Insert(PostPhuongXaRequest request)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        public IActionResult Update(PostPhuongXaRequest request)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        public IActionResult GetAllForCombobox(GetAllPhuongXaRequest request)
        {
            try
            {
                if (!ModelState.IsValid)
